        ...
        $this
            ...
            ->then
                ...
                ->mock($output)->call('writeln')
                    ...
                    ->withArguments($message . PHP_EOL . '  <comment>' . $choice . '</comment>' . PHP_EOL . '  <comment>' . $otherChoice . '</comment>' . PHP_EOL . '  <comment>' . $line . '</comment>')->once()
                ->mock($readline)->call('readLine')->withArguments(': ')->twice()
            ...
            ->then
                ...
                ->mock($output)->call('writeln')
                    ...
                    ->withArguments($message . PHP_EOL . '  <comment>' . $choiceKey . '</comment>: ' . $choice . PHP_EOL . '  <comment>' . $otherChoiceKey . '</comment>: ' . $otherChoice . PHP_EOL . '  <comment>' . $lineKey . '</comment>: ' . $line)->once()
            ->given($this->calling($readline)->readLine = null)
